...
Atuo com tecnologia, tenho experiência em Salesforce Marketing Cloud, atuação em times ágeis utilizando Scrum, com foco em entregas contínuas e colaboração em equipe, participando de rotinas como planejamento, refinamento, homologações e publicações em produção.
